  ...
  return (
    <div id='designs' className='px-9 py-20 h-auto lg:px-28 overflow-hidden flex flex-col gap-8 lg:flex-row'>
        <div className='flex flex-col gap-3 lg:w-2/5'>
            ...
            <p className='text-sm leading-8'>I craft user-friendly websites & captivating graphic designs, from mockups to printables. Here are some of my favorites.</p>
        </div>
                ...
                Design.map(designs => (
                    <div className='flex flex-col gap-2 items-center'>
                        ...
                        <div className='flex flex-col gap-2 justify-center w-80'>
                            ...
                            <p className='font-normal leading-6 text-sm text-pretty'>{designs.description}</p>
