  ...
  return (
    <div id='contact' className='relative px-9 lg:px-28 h-screen flex flex-col justify-center items-center overflow-hidden'>
        <div className='flex flex-col lg:w-1/2 gap-2'>
            <h1 className='text-3xl font-medium text-left lg:text-5xl'>Actively seeking opportunities to collaborate and open to freelance projects.</h1>
            <a href="mailto:biancamarie.victorino@gmail.com" className='text-3xl text-left underline decoration-solid font-medium text-primary-color lg:text-5xl flex flex-row hover:-translate-y-1 transition ease-in-out duration-100 delay-200'>Let's Connect <MdArrowOutward size={40} /></a>
        </div>
